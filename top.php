...
<head>
    ...
    <link rel="shortcut icon" type="image/x-icon" href="asset_front/images/favicon.ico">
    ...
    <link rel="stylesheet" href="asset_front/css/owl.carousel.min.css">
    <link rel="stylesheet" href="asset_front/css/owl.theme.default.min.css">
    <!-- This core.css file contents all plugings css file. -->
    <link rel="stylesheet" href="asset_front/css/core.css">
    <!-- Theme shortcodes/elements style -->
    <link rel="stylesheet" href="asset_front/css/shortcode/shortcodes.css">
    <!-- Theme main style -->
    <link rel="stylesheet" href="asset_front/style.css">
    <!-- Responsive css -->
                    ...
                    <div class="row">
                        <div class="menumenu__container clearfix">
                            <div class="col-lg-2 col-md-2 col-sm-3 col-xs-5">
                                <div class="logo">
                                    <a href="index.html"><img src="asset_front/images/logo/4.png" alt="logo images"></a>
                                </div>
                            </div>
